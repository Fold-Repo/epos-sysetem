...
import { SaleReturnType, SaleReturnQueryParams } from '@/types'
import SaleReturnTable from './SaleReturnTable'
import { useRouter } from 'next/navigation'
import { useGetSaleReturns } from '@/services'
...
const SaleReturnView = () => {
    ...
    const queryParams: SaleReturnQueryParams = {
    ...
    // FETCH SALES RETURNS
    // ================================
    const { data, isLoading } = useGetSaleReturns(queryParams)
    const { saleReturns, pagination } = data || {}
    
    // ================================
    // SELECTION STATE
    // ================================
    const [selectedReturns, setSelectedReturns] = useState<SaleReturnType[]>([])
    ...
    return (
        <>
            <DashboardBreadCrumb
                title="Sales Returns"
                description="Manage your sales returns here."
            />
            ...
            <div className="p-3 space-y-3">
                ...
                <DashboardCard bodyClassName='space-y-4'>
                    ...
                    <SaleReturnTable
                        ...
                        onView={(returnId) => router.push(`/dashboard/sale-returns/${returnId}`)}
                        loading={isLoading}
                    />

...
import ExpiryProductTable from './ExpiryProductTable'

const ExpiryTab = () => {
    const [currentPage, setCurrentPage] = useState(1)
    const itemsPerPage = 25

    // Hardcoded expiry data
    const expiryData = [
        {
            id: '1',
            sku: 'PT001',
        ...
        },
        {
            ...
            manufacturedDate: '2024-12-25',
            expiredDate: '2026-12-21'
        },
        {
            id: '3',
            sku: 'PT003',
            ...
            manufacturedDate: '2024-12-26',
            expiredDate: '2026-12-22'
        },
        {
            id: '4',
            sku: 'PT004',
            ...
            manufacturedDate: '2024-12-30',
            expiredDate: '2026-12-25'
        },
        {
            id: '5',
            sku: 'PT005',
            ...
            manufacturedDate: '2024-12-28',
            expiredDate: '2026-12-26'
        }
    ]
    ...
    return (
        <div className="space-y-4">
            ...
            <ExpiryProductTable data={expiryData} />

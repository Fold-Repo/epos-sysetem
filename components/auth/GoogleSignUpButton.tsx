...
const GoogleSignUpButton: React.FC<GoogleSignUpButtonProps> = ({
    ...
    return (
        <Button
            ...
            radius="lg"
            variant="bordered"
            className={`w-full h-12 text-sm font-medium border-gray-200 bg-white text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all ${className}`}
            onPress={handleGoogleSignUp}
            isLoading={isLoading || isInternalLoading}
            isDisabled={isLoading || isInternalLoading}
        >
